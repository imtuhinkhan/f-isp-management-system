...
import {updatePackage,findPackageById} from '../../services/package'
...
class PackageEdit extends Component {
    ...
    componentDidMount(){
        findPackageById(this.props.match.params.id).then((res)=>{
            this.setState({packageName: res.data.name, price:res.data.price})
    ...
    async submitFrom(e){
        ...
        const response = await updatePackage(postBody,this.props.match.params.id);
