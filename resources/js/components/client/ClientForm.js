...
import {storeClient} from '../../services/client'
...
class ClientForm extends Component {
    ...
    async submitFrom(e){
        ...
        const response = await storeClient(postBody);
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <select className="form-control" name="package" onChange={(e)=>this.changeInput(e)}>
